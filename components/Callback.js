...
export default function Callback() {
  ...
  const triggerToggle = () => {
    setDropdownOnClose(!dropdownOnClose);
  };

  const handleOutsideClick = (event) => {
    if (
      buttonDropDown.current &&
      !buttonDropDown.current.contains(event.target)
    ) {
      setDropdownOnClose(false);
    }
  };
  ...
  return (
    <div
      ...
      className={
        !dropdownOnClose
          ? "fixed right-4 bottom-20 bg-red-600 border-2 border-white rounded-full p-1.5 z-10 mp-social"
          : "fixed right-4 bottom-20 bg-red-600 border-2 border-white rounded-full p-1.5 z-10 mp-social-active"
      }
    >
      {dropdownOnClose ? (
        <div>
          ...
          <div className="mp_social_4 mb-2.5">
            <a>
              ...
              >
                <g id="fotter">
                  <ellipse
                    className="cb-phoneSocial-cls-1"
                    cx="329.76"
                    cy="323.08"
                    rx="330.44"
                    ry="324.38"
                ...
                <g id="page2">
                  <rect
                    className="cb-phoneSocial-cls-2"
                    x="192.92"
                    y="53.41"
                    width="282"
                    height="547.42"
      ...
      >
        <span className="absolute top-0 right-0 w-full h-full bg-red-400 rounded-full opacity-75 z-20 animate-ping"></span>
        {!dropdownOnClose ? (
          <svg
